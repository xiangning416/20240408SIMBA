...
class SpatialFeature(object):
    ...
    def __init__(self, boundaryList: List[List[geometry.Polygon]], fov: int,
                 ...
                 transcriptList: List[pandas.DataFrame] = None, cyto_volume: float = None, 
                 label: int = -1) -> None:
        ...
        if cyto_volume is not None:
            self._cyto_volume = cyto_volume
        else:
            self._cyto_volume = 0
    ...
    def get_cyto_volume(self) -> float: 
        return self._cyto_volume

    def set_cyto_volume(self, volume: float) -> None:
        self._cyto_volume = volume
    ...
    def contains_point(self, point: geometry.Point, zIndex: int) -> bool:
        ...
        Returns:
            True if the boundaries of this spatial feature in the zIndex planeprint
...
class HDF5SpatialFeatureDB(SpatialFeatureDB):
    ...
    def _save_feature_to_hdf5_group(h5Group: h5py.Group,
        ...
        featureGroup.attrs['cyto_volume'] = feature.get_cyto_volume()
